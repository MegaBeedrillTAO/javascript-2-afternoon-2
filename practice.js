...
function divider(numbersArray){
  for (j = 0; j < numbersArray.length; j++){
    if (numbersArray[j] % 2 === 0){
      ...
      evenArray.push(numbersArray[j]);
      
    }
    else if (numbersArray[j] % 2 === 1){
      oddArray.push(numbersArray[j]);
    }
    
  }
  var newArray = [evenArray, oddArray];
  return newArray;
}
...
function addTen(numbers){
  for (i = 0; i < numbers.length; i++){
    tenArray.push(10 + parseInt(numbers[i]));
  }
  return tenArray;
}
...
var user2 = {
  name: 'Mark McIver',
  email: 'mark.mcidevmounta.in',
  password: 'hunter2',
  username: 'ihazcode'
};
var user3 = {
  name: 'Mark McIver',
  email: 'mariver@devmounta.in',
  password: 'hunter2',
  username: 'ihazcode'
};
var user4 = {
  name: 'Mark McIver',
  email: 'mark.iver@devmounta.in',
  password: 'hunter2',
  username: 'ihazcode'
};
users.push(user1);
